...
export const resumeExperience: ResumeExperience[] = [
  ...
  },
  {
    ...
    period: '2023 – Present',
    bullets: [
      'Published 50+ production Android applications on Google Play across business, games, and utilities.',
