...
export const metadata: Metadata = {
  ...
  description:
    'Md. Jahidul Islam builds production web apps, AI tools, and 200+ Android products. Full-stack engineer specializing in React, Node.js, and system design.',
  metadataBase: new URL('https://jahidbappi.vercel.app'),
  openGraph: {
    title: 'Jahid Bappi — Full-Stack Engineer & AI Builder',
    description:
      'Production web apps, AI tools, and 200+ Android products shipped to real users.',
  ...
  twitter: {
    ...
    title: 'Jahid Bappi — Full-Stack Engineer & AI Builder',
    description: 'Production web apps, AI tools, and 200+ Android products.',
  },
